...
| File | What It Does |
|------|-------------|
| `script1.sh` | Displays information about the kernel, user, and uptime of system |
| `script2.sh` | Report Answers the question whether a package is installed correctly and provides the information |
| `script3.sh` | Designates grants and sizes of key directories |
| `script4.sh` | Determines the number of times that a heyword is repeated in a log file |
| `script5.sh` | Prompts you to answer 3 easy questions and comes up with your open source statement |
